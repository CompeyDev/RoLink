...
module.exports = class UpdateCommand extends Command {
  ...
  hasPermission(msg) {
    ...
    return (
      ...
      msg.member.roles.cache.find((role) => role.name === "RoLink Admin") ||
      msg.member.roles.cache.find((role) => role.name === "RoLink Updater") ||
      !msgArgs ||
  ...
  async fn(msg, args) {
    ...
    if (!target || !(target instanceof Role)) {
      ...
      return msg.reply(
        "Sorry, updating more than one user is only available with RoLink Plus: <https://RoLink.link/plus>.",
      )
    } else {
