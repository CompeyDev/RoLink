...
module.exports = class NicknameFormatCommand extends Command {
  constructor(client) {
    super(client, {
      name: "nicknameformat",
      ...
      description:
        "`<format>` Set the format RoLink will use when setting users' nicknames. Available replacements can be seen at https://RoLink.link/manual. Default `%USERNAME%`.",
