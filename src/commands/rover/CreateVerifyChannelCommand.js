...
module.exports = class CreateVerifyChannelCommand extends Command {
  constructor(client) {
    super(client, {
      ...
      aliases: [
        ...
        "createverification",
        "createverifychannels",
      ],
      description:
        "Creates a channel category with verification instructions for new members and a channel for users to verify themselves",
    })
  }
  ...
  async fn(msg) {
    try {
      ...
      const instructionsChannel = await msg.guild.channels.create(
        "verify-instructions",
        {
          type: "text",
          parent: category,
      ...
      msg.reply(
        `Created channels ${verifyChannel} and ${instructionsChannel}. You can delete the default message in the instructions channel and replace it with your own if you wish.`,
      )
    } catch (err) {
      msg.reply(
