    ...
    if (data.status === "ok") {
        ...
        if (
          ...
          try {
            ...
            return status({
              ...
              nonFatal: true,
              error:
                "There was an error while trying to assign the verified role! Ensure RoVer's role is above it." +
                errorAppend,
            })
          }
        }
        ...
        if (
          ...
          try {
            ...
            return status({
              ...
              nonFatal: true,
              error:
                "There was an error while trying to remove the verified role! Ensure RoVer's role is above it." +
                errorAppend,
            })
          }
        }
      ...
      if (
        ...
        !this.member.roles.cache.find(
          (role) => role.name === "RoVer Nickname Bypass",
        ) &&
            ...
            return status({
              ...
              error:
                this.member.guild.ownerID === this.member.id
                  ...
                  : "RoVer doesn't have permission to change that user's nickname." +
                    errorAppend,
            })
          }
        }
          ...
          if (options.message) {
            ...
            if (VerificationAttempts.get(this.id) > 1) {
              error = stripIndents`:question: Looks like you are having trouble verifying your account! Here are some things you can try:
                ...
                - Try visiting <https://rover.link/verify> in an incognito / private browser window. (It's possible you are signed into the wrong Discord account in your browser)
