...
module.exports = class JoinMessageCommand extends Command {
      ...
      args: [
        {
          ...
          label: "state",
          prompt:
            "Should users get direct messaged with your welcome message or verification instructions when they join this server? (on|off)",
          type: "boolean",
        },
      ],
    })
  ...
  async fn(msg, args) {
    ...
    if (args.state) {
      msg.reply(
        "The bot will now direct message new users with the welcome message or verification instructions.",
      )
    } else {
      msg.reply(
        "The bot will no longer direct message new users with the welcome message or verification instructions.",
      )
    }
  }
}
